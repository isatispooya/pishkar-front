...
const IssuingInsurenceCunsoltant = (props) =>{
    ...
    const GetDataDashboard = () =>{
        axios({method:'POST',url:OnRun+'/dashboard/cunsoltantissuniginsurer',data:{cookie:LginKy, period:Period, cunsoltant:props.consultant}
    ...
    useEffect(GetDataDashboard,[Period, props.consultant])
...
export default IssuingInsurenceCunsoltant