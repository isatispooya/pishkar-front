...
const InssuingSumCunsoltant = (props) =>{
    ...
    const GetDataDashboard = () =>{
        axios({method:'POST',url:OnRun+'/dashboard/cunsoltantissunigsum',data:{cookie:LginKy, period:Period,cunsoltant:props.consultant}
...
export default InssuingSumCunsoltant