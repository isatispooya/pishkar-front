...
const IssunigFeildCunsoltant = (props) =>{
    ...
    const GetDataDashboard = () =>{
        axios({method:'POST',url:OnRun+'/dashboard/cunsoltantissunigFeild',data:{cookie:LginKy, period:Period,cunsoltant:props.consultant}
...
export default IssunigFeildCunsoltant