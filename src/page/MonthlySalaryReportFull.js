...
const MonthlySalaryReportFull = () =>{
    ...
    if(Pay!=null){
        ...
        var columnsTable=[
                ...
                {title:"کدملی",visible:handleGSC('کدملی'), field:"nationalCode", hozAlign:'center',headerHozAlign:'center',resizable:true, widthGrow:4,headerFilter:"input",formatter:function(cell){return(cell.getValue().toLocaleString())},headerMenu: headerMenu},
                ...
                {title:"پایه روزانه",visible:handleGSC('پایه روزانه'), field:"baseDaily", hozAlign:'center',headerHozAlign:'center',resizable:true, widthGrow:3,headerFilter:"input",bottomCalc:'sum',formatter:function(cell){return(cell.getValue().toLocaleString())},headerMenu: headerMenu},
                {title:"سنوات روزانه",visible:handleGSC('سنوات روزانه'), field:"sanavatDaily", hozAlign:'center',headerHozAlign:'center',resizable:true, widthGrow:3,headerFilter:"input",bottomCalc:'sum',formatter:function(cell){return(cell.getValue().toLocaleString())},headerMenu: headerMenu},
                ...
                {title:"مشمول مالیات",visible:handleGSC('مشمول مالیات'), field:"inTax", hozAlign:'center',headerHozAlign:'center',resizable:true, widthGrow:3,headerFilter:"input",bottomCalc:'sum',formatter:function(cell){return(cell.getValue().toLocaleString())},headerMenu: headerMenu},
                ...
                {title:"معافیت",visible:handleGSC('معافیت'), field:"freeTaxe", hozAlign:'center',headerHozAlign:'center',resizable:true, widthGrow:3,headerFilter:"input",bottomCalc:'sum',formatter:function(cell){return(cell.getValue().toLocaleString())},headerMenu: headerMenu},
                ...
                {title:"حق بیمه کارفرما",visible:handleGSC('حق بیمه کارفرما'), field:"insuranceEmployer", hozAlign:'center',headerHozAlign:'center',resizable:true, widthGrow:3,headerFilter:"input",bottomCalc:'sum',formatter:function(cell){return(cell.getValue().toLocaleString())},headerMenu: headerMenu},
...
export default MonthlySalaryReportFull